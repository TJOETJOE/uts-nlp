# -*- coding: utf-8 -*-
"""Copy of YoutubeCommentsCrawlerV2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1iOXZSYoOonzh93JnKFjtm2cX4yjXAyZm
...
**Tujuan** dari program ini adalah melakukan crawling (pengambilan) data komentar pada sebuah video Youtube menggunakan **Youtube Data API v3**.  pastikan aktifkan layanan Youtube Data API
